...
export function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen pt-32 pb-20 overflow-hidden w-full flex items-center">
      {/* Background Elements */}
            ...
            <div className="flex-1">
              ...
              >
                <Button 
                  size="lg" 
                  className={cn(
                    "bg-morocco-blue text-white hover:bg-morocco-deep-blue group relative overflow-hidden transition-all duration-500",
                    isHovered ? "pl-10 pr-12" : "px-6"
                  )}
                ...
                >
                  <span className={cn(
                    "absolute inset-y-0 left-0 flex items-center justify-center w-0 bg-morocco-navy transition-all duration-500",
                    isHovered ? "w-8" : "w-0"
                  )}>
                  ...
                  <ArrowRight className={cn(
                    "ml-2 h-4 w-4 transition-all duration-500",
                ...
                <Button 
                  size="lg"
                  variant="outline" 
                  className="border-morocco-blue text-morocco-blue hover:bg-morocco-blue/5"
              ...
              >
                {["Suivi en temps réel", "Gestion des tâches", "Rapports automatisés"].map((feature, index) => (
                  <div 
                    key={feature} 
                ...
                <div className="relative aspect-[4/3] w-full max-w-lg mx-auto">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-morocco-blue to-morocco-deep-blue rounded-xl shadow-2xl overflow-hidden border-4 border-white transform rotate-1 transition-all hover:rotate-0 duration-500">
                    <img 
                      ...
                      className="w-full h-full object-cover opacity-95 mix-blend-overlay hover:scale-105 transition-transform duration-700"
                    />
                  ...
                  <motion.div 
                    className="absolute -bottom-12 -left-8 w-40 bg-white rounded-lg shadow-lg p-2 transform -rotate-3"
                    animate={{ 
                      y: [0, -8, 0],  
                    }}
                    transition={{ 
                  ...
                  <motion.div 
                    className="absolute -top-10 -right-6 w-32 bg-white rounded-lg shadow-lg p-2 transform rotate-6"
                    animate={{ 
                      y: [0, -10, 0],  
                    }}
                    transition={{ 
