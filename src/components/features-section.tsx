...
import { LayoutDashboard, ClipboardList, Truck, FileText, Bell, Calendar, Users, Smartphone, Play, Info } from "lucide-react";
...
export function FeaturesSection() {
  ...
  return <section id="features" className="relative py-24 overflow-hidden bg-gray-50 w-full">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div id="dashboard-preview" className="mb-16 md:mb-20 w-full">
          ...
          <Carousel className="w-full max-w-5xl mx-auto">
            <CarouselContent>
              {dashboardImages.map((image, idx) => <CarouselItem key={idx}>
                  <div className="p-1 md:p-2">
                    <Card className="overflow-hidden border-2 border-gray-100 shadow-xl rounded-xl bg-white">
                      <CardContent className="p-0">
                        <div className="relative aspect-video overflow-hidden">
                          <img src={image.src} alt={image.alt} className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8 mt-12">
          ...
          duration: 0.5,
          delay: index * 0.1
        }} className={cn("relative group rounded-xl p-6 bg-white shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100", activeFeature === index ? "ring-2 ring-morocco-blue" : "")}>
              <div className={cn("w-12 h-12 mb-5 rounded-lg flex items-center justify-center bg-gradient-to-br", feature.color)}>
              ...
              <div className="flex justify-between items-center">
                ...
                <Button size="sm" variant="ghost" className="text-gray-500 hover:text-morocco-navy hover:bg-gray-100">
